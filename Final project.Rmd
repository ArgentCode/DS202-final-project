...
# 2 sentences summary: Most houses were built around 1950-1955, not so many houses neither before 1920 nor after 2000 were analyzed 
...
HousingOriginal %>% 
ggplot(aes(x=airconditioningtypeid))+geom_line(stat="density", color="Red", size=1)+theme_bw()
# 2 sentences summary:
