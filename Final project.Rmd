...
Airconditioning is a rather recent invention compared to some of these houses. With that in mind, I am quite curious what airconditioning systems are most common for different eras
```{r}
